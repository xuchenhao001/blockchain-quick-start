...
if [[ $RUN_METHOD = "N" || $RUN_METHOD = "n" ]]; then
  ...
  docker run -ti --rm -e DEV_PATH=$PWD -v $PWD/../../:/blockchain-quick-start hyperledger/fabric-tools:1.3.0 bash -c "cd /blockchain-quick-start/sample-network/docker-compose && ./start.sh"
